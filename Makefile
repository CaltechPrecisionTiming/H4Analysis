...
DEPS_OBJS = lib/utils.o lib/WFClass.o lib/WFClassNINO.o lib/FFTClass.o lib/WFViewer.o lib/MCPAnalyzer.o \
	lib/H4Tree.o lib/RecoTree.o lib/DigiTree.o lib/WFTree.o lib/PositionTree.o lib/PluginBase.o lib/H4Dict.so lib/T1065Tree.o lib/TOFPETRawTree.o lib/TOFPETRecoTree.o lib/Aux.o lib/Config.o
...
PLUG_OBJS = lib/libDigitizerReco.so lib/libMakeCovarianceMatrix.so \
	...
	lib/libInfoTreeMaker.so lib/libADCReco.so lib/libWFAnalyzer.so lib/libFFTAnalyzer.so lib/libT1065Reco.so lib/libTOFPETReco.so
